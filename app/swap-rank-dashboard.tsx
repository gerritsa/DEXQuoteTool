...
export default function SwapRankDashboard({
  ...
  return <main className="app-shell" id="top">
    ...
    <footer><Link className="footer-brand" href="/"><span className="brand-symbol"><i /><i /><i /></span><b>SwapRank</b></Link>{view === "analysis" ? <a href={initialQuery.back}>← Leaderboard</a> : <a href="#top">Back to top ↑</a>}</footer>
  </main>;
}
