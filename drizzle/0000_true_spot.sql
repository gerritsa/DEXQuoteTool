...
CREATE INDEX IF NOT EXISTS `idx_benchmark_runs_initiated` ON `benchmark_runs` (`initiated_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_protocol_quotes_run_protocol` ON `protocol_quotes` (`run_id`,`protocol`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_trend_buckets_lookup` ON `trend_buckets` (`pair_id`,`amount_id`,`mode`,`bucket_seconds`,`bucket_start`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_trend_buckets_retention` ON `trend_buckets` (`bucket_seconds`,`bucket_start`);--> statement-breakpoint
PRAGMA optimize;
